...
> In order to format JSON in the browser nicely, you might need a plugin like Chrome's [JSON View](https://chrome.google.com/webstore/detail/jsonview/chklaanhfefbnpoihckbnefhakgolnmc?hl=en).
